...
'''
Variant4: add more filters
'''
model = models.Sequential()
model.add(layers.Conv2D(64, (3, 3), activation='relu', kernel_initializer='he_normal', input_shape=(28, 28, 1)))
...
model.summary()
# plot the model
tf.keras.utils.plot_model(model, to_file='Variant4_model.png')
tf.keras.utils.plot_model(model, show_shapes = True, to_file='Variant4_model1.png')
...
with open("Variant4.json", "w") as json_file:
    json_file.write(model_json)
model.save_weights("Variant4_weights.h5")
print("Model saved")


# load json and create model
json_file = open('Variant4.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
# load weights into new model
loaded_model.load_weights("Variant4_weights.h5")
