...
model.summary()
# plot the model
tf.keras.utils.plot_model(model, to_file='Variant1_model.png')
tf.keras.utils.plot_model(model, show_shapes = True, to_file='Variant1_model1.png')
...
json_file = open('Variant1.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
# load weights into new model
loaded_model.load_weights("Variant1_weights.h5")
