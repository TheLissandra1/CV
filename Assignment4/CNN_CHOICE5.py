...
data_augmentor.fit(train_images.reshape(len(train_images), 28, 28, 1))
...
augment = data_augmentor.flow(train_images.reshape(len(train_images), 28, 28, 1)[1:2], batch_size=1)
...
with open("Choice5.json", "w") as json_file:
    json_file.write(model_json)
model.save_weights("Choice5_weights.h5")
print("Model saved")


# load json and create model
json_file = open('Choice5.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
# load weights into new model
loaded_model.load_weights("Choice5_weights.h5")
