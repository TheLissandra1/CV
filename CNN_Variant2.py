...
model.summary()
# plot the model
tf.keras.utils.plot_model(model, to_file='Variant2_model.png')
tf.keras.utils.plot_model(model, show_shapes = True, to_file='Variant2_model1.png')


# compile and train
'''
Variant 2: learning rate and optimizer
'''
...
with open("Variant2.json", "w") as json_file:
    json_file.write(model_json)
model.save_weights("Variant2_weights.h5")
print("Model saved")


# load json and create model
json_file = open('Variant2.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
# load weights into new model
loaded_model.load_weights("Variant2_weights.h5")
